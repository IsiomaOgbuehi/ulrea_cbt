...
from cbt_service.schemas.item_subject_schemas import SubjectCreate, SubjectUpdate, CurrentUser
from cbt_service.database.models.enums.item_subject_enums import SubjectStatus
